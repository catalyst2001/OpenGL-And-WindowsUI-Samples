...
void CCamera::SetViewByMouse()
{
	...
	int middleX = m_screen_width  >> 1;				// This is a binary shift to get half the width
	int middleY = m_screen_height >> 1;				// This is a binary shift to get half the height
...
void CCamera::UpdateScreenResoluiton(int width, int height)
{
