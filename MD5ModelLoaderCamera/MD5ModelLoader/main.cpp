...
int main( int argc, char* argv[] )
{
	...
	g_Model.LoadModel( "untitled.md5mesh" );
	//g_Model.LoadAnim( "demon\\walk3.md5anim" );
	//g_Model.LoadAnim( "demon\\oneshot.md5anim" );
    glutMainLoop();
}
