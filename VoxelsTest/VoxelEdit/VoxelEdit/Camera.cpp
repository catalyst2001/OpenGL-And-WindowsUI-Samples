...
void CCamera::SetViewByMouse()
{
	...
	int middleX = m_width >> 1;				// This is a binary shift to get half the width (width / 2)
	int middleY = m_height >> 1;				// This is a binary shift to get half the height (height / 2)
