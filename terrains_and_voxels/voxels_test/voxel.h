...
public:
	...
	* Функция вычисляет к какой точке треугольника находится ближе
	...
	* если он есть, мы меняем флаг этого вокселя и завершаем цикл. Если вокселя в этой точке нет, мы увеличиваем скаляр на 1 и пропускаем
	* эту итерацию цикла.
